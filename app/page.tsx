...
function Field({
  ...
  return (
    <div className="flex flex-col gap-1 py-4 sm:grid sm:grid-cols-[8rem_1fr] sm:gap-4">
...
export default function Home() {
  return (
    <div className="flex flex-1 items-center justify-center bg-paper px-4 py-10 sm:py-16 md:py-24">
      <main className="relative w-full max-w-xl">
        <div className="relative rounded-xs border border-line bg-card px-5 py-7 shadow-[0_1px_0_rgba(32,27,18,0.05)] sm:px-8 sm:py-9 md:px-11 md:py-11">
          ...
          <header>
            ...
            <h1 className="mt-2 font-display text-[22px] font-semibold leading-tight tracking-tight text-ink sm:text-[26px] md:text-[30px]">
